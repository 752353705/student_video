...
var tabbar = function tabbar() {__webpack_require__.e(/*! require.ensure | components/tabbar */ "components/tabbar").then((function () {return resolve(__webpack_require__(/*! ./components/tabbar.vue */ 119));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('tabbar', tabbar);var uniPopup = function uniPopup() {Promise.all(/*! require.ensure | components/uni-popup/uni-popup */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/uni-popup/uni-popup")]).then((function () {return resolve(__webpack_require__(/*! ./components/uni-popup/uni-popup.vue */ 126));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('uniPopup', uniPopup); // import uniPopupMessage from './components/uni-popup/uni-popup-message.vue'
// Vue.component('uniPopupMessage',uniPopupMessage)
var uniPopupDialog = function uniPopupDialog() {__webpack_require__.e(/*! require.ensure | components/uni-popup/uni-popup-dialog */ "components/uni-popup/uni-popup-dialog").then((function () {return resolve(__webpack_require__(/*! ./components/uni-popup/uni-popup-dialog.vue */ 135));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('uniPopupDialog', uniPopupDialog); // 引入上传作品组件
var uniPopupPushvideo = function uniPopupPushvideo() {Promise.all(/*! require.ensure | components/uni-popup/uni-popup-pushvideo */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/uni-popup/uni-popup-pushvideo")]).then((function () {return resolve(__webpack_require__(/*! ./components/uni-popup/uni-popup-pushvideo.vue */ 142));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('uniPopupPushvideo', uniPopupPushvideo); // 引入进度环组件
var cCircle = function cCircle() {__webpack_require__.e(/*! require.ensure | components/cCircle */ "components/cCircle").then((function () {return resolve(__webpack_require__(/*! ./components/cCircle.vue */ 150));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('cCircle', cCircle); // 封装全局登录函数
...
_vue.default.config.productionTip = false;_App.default.mpType = 'app';var app = new _vue.default(_objectSpread({ store: _index.default }, _App.default));
createApp(app).$mount();
