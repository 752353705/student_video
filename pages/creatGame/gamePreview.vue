<template>
	<view class="game_detail">
		...
		<view style="color: white;text-align: center;margin-top: 40rpx;"
			v-if="game_user.length == 0 && tab_act !== 0"
			>
			—— 暂无参赛选手 ——
		</view>
...
<script>
	export default {
		...
		onLoad(option) {
			console.log('参数 gameDetail',option)
			this.game_detail = JSON.parse(decodeURIComponent(option.item));
		},
		methods:{
